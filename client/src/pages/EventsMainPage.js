...
export default function EventsMainPage(){
    ...
    return(
        <div className="containerDiv">
            ...
            <div className="card bg-white " >
                <div className="card-body">
                    <img className="card-img" src="/images/audience-1.jpg" alt="" style={{ maxWidth: "400px" }}/>
                    <div className="card-img-overlay d-flex">
                ...
                <div className="card">
                 <div className="card-body">
                    <img className="card-img" src="/images/sportsPB/soccer-1.jpg" alt="" style={{ maxWidth: "400px" }}/>
                    <div className="card-img-overlay d-flex">
                ...
                <div className="card">
                    <div className="card-body">
                    <img className="card-img" src="/images/spaghetti-1.jpg" alt="" style={{ maxWidth: "400px" }}/>
                    <div className="card-img-overlay d-flex">
