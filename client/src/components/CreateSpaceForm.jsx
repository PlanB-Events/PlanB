...
export default function CreateSpaceForm(){
    ...
    function handleChange(event){
        ...
        const value = (name === "allowedPets" || name === "allowedBeverages" || name === "covidTest" || name === "wheelchairAccess") ? event.target.options[event.target.selectedIndex].value : event.target.value;
